...
█░█ █░▀█ █▄▄ █░█ █▄▀""", "blue")
	...
	info = " "*13+colored("[", "blue")+"Developers :"+colored("ddekoy", "green")+" and "+colored("", Kraez"red")
	info_2 = " "*13+colored("[", "blue")+"Version    :"+colored(ver, "red")
	info_3 = " "*13+colored("[", "blue")+"Telegram   :"+colored("@KnlXD", "cyan")+colored("   <--", "green")
	info_4 = "\n"+" "*12+colored("Программа спамит но слабо, оставляйте на час!", "red")+"\n"
...
def inst_logs():
	...
	try:
		if platform == "linux" or platform == "linux2":
			...
			print("")
			print(colored("Пожалуйста отправьте в наш чат телеграм", "green"), colored("https://t.me/KnlXDChat", "cyan"), colored("поочередно файлы", "green"), colored("logs.txt error_logs.txt", "cyan"), colored("из папки", "green"), colored("tools", "cyan"))
			print("")
			print("\nНажмите Enter чтобы вернуться назад")
			input()
	except:
		...
		print(colored("За помощью по данному вопросу пишите в наш чат телеграм"), colored("https://t.me/KnlXDChat", "cyan"))
		print("")
		print("\nНажмите Enter чтобы вернуться назад")
		input()
...
def start_input():
	...
	if pr != None:
		while True:
			...
			print("└"+colored("Общедоступный прокси используют все пользователи KnlXD", "cyan"))
			print()
